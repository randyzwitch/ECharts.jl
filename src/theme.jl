...
const chalk = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/chalk.json")))
const dark = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/dark.json")))
const essos = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/essos.json")))
const halloween = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/halloween.json")))
const infographic = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/infographic.json")))
const macarons = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/macarons.json")))
const roma = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/roma.json")))
const purplepassion = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/purple-passion.json")))
const roma = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/roma.json")))
const shine = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/shine.json")))
const vintage = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/vintage.json")))
const walden = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/walden.json")))
const westeros = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/westeros.json")))
const wonderland = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/wonderland.json")))

#custom themes
#grayscale based on 6-color Colorbrewer sequential single-hue
const grayscale = Theme(JSON.parsefile(joinpath(dirname(@__FILE__), "..", "docs/themes/grayscale.json")))
