...
@with_kw type LineStyle <: AbstractEChartType
    ...
    width::Union{Int64,Void} = 1
    _type::Union{String,Void} = "solid"
    shadowBlur::Union{Int64,Void} = 1
    shadowColor::Union{String,Void} = nothing
    shadowOffsetX::Union{Int64,Void} = 0
    shadowOffsetY::Union{Int64,Void} = 0
    opacity::Union{Int64,Void} = nothing
end
...
@with_kw type TextStyle <: AbstractEChartType
    ...
    fontSize::Union{Int64,Void} = 12
end
@with_kw type SplitArea <: AbstractEChartType
    interval::Union{Int64,String,Void} = "auto"
...
@with_kw type AxisLabel <: AbstractEChartType
    ...
    rotate::Union{Int64,Void} = 0
    margin::Union{Int64,Void} = 8
...
@with_kw type ItemStyleOpts <: AbstractEChartType
    ...
    borderWidth::Union{Int64,Void} = 0
    shadowBlur::Union{Int64,Void} = nothing
    shadowColor::Union{String,Void} = nothing
    shadowOffsetX::Union{Int64,Void} = 0
    shadowOffsetY::Union{Int64,Void} = 0
...
@with_kw type AxisPointer <: AbstractEChartType
    ...
    animationThreshold::Union{Int64,Void} = 2000
    animationDuration::Union{Int64,Void} = 1000
    animationDelay::Union{Int64,Void} = 1000
    animationDurationUpdate::Union{Int64,Void} = 300
    animationEasingUpdate::Union{String,Void} = "cubicOut"
    animationDelayUpdate::Union{Int64,Void} = 0
    lineStyle::Union{LineStyle,Void} = nothing
...
@with_kw type Tooltip <: AbstractEChartType
    ...
    showDelay::Union{Int64,Void} = 0
    hideDelay::Union{Int64,Void} = 100
...
@with_kw type Legend <: AbstractEChartType
    show::Union{Bool,Void} = true
    zlevel::Union{Int64,Void} = 0
    z::Union{Int64,Void} = 2
    left::Union{Int64,String,Void} = "auto"
    top::Union{Int64,String,Void} = "auto"
    right::Union{Int64,String,Void} = "auto"
    bottom::Union{Int64,String,Void} = "auto"
    width::Union{Int64,String,Void} = "auto"
    height::Union{Int64,String,Void} = "auto"
    orient::Union{String,Void} = "horizontal"
    align::Union{String,Void} = "auto"
    padding::Union{Int64,Void} = 5
    itemGap::Union{Int64,Void} = 10
    itemWidth::Union{Int64,Void} = 25
    itemHeight::Union{Int64,Void} = 14
    formatter::Union{String,Void} = nothing
...
@with_kw type Axis <: AbstractEChartType
    ...
    nameGap::Union{Int64,Void} = 15
    inverse::Union{Bool,Void} = false
    boundaryGap::Union{AbstractVector,Bool,Void} = nothing
    min::Union{Int64,String,Void} = nothing
    max::Union{Int64,String,Void} = nothing
    scale::Union{Bool,Void} = false
    splitNumber::Union{Int64,Void} = 5
    minInterval::Union{Int64,Void} = 0
    interval::Union{Int64,Void} = nothing
...
@with_kw type Title <: AbstractEChartType
    ...
    padding::Union{Array{Int64,1},Int64,Void} = 5
    itemGap::Union{Int64,Void} = 5
    zlevel::Union{Int64,Void} = 0
    z::Union{Int64,Void} = 2
    left::Union{Int64,String,Void} = "left"
    top::Union{Int64,String,Void} = "auto"
    right::Union{Int64,String,Void} = "auto"
    bottom::Union{Int64,String,Void} = "auto"
    backgroundColor::Union{String,Void} = "transparent"
...
@with_kw type Grid <: AbstractEChartType
    ...
    z::Union{Int64,Void} = 2
    left::Union{Int64,String,Void} = "auto"
    top::Union{Int64,String,Void} = 60
    right::Union{Int64,String,Void} = "10%"
    bottom::Union{Int64,String,Void} = 60
    width::Union{Int64,String,Void} = "auto"
    height::Union{Int64,String,Void} = "auto"
...
@with_kw type Timeline <: AbstractEChartType
    ...
    symbolSize::Union{Array{Int64,1},Int64,Void} = 10
    symbolRotate::Union{Int64,Void} = nothing
    symbolOffset::Union{Array{Int64,1},Void} = [0,0]
    lineStyle::Union{LineStyle,Void} = nothing
...
@with_kw type RadiusAxis <: AbstractEChartType
    ...
    min::Union{Int64,String,Void} = "auto"
    max::Union{Int64,String,Void} = "auto"
    scale::Union{Bool,Void} = false
    splitNumber::Union{Int64,Void} = 5
    minInterval::Union{Int64,Void} = 0
    interval::Union{Int64,Void} = nothing
...
@with_kw type Radar <: AbstractEChartType
    ...
    z::Union{Int64,Void} = 2
    center::Union{Array{String,1},Void} = String["50%","50%"]
    radius::Union{Int64,String,Void} = "75%"
    startAngle::Union{Int64,Void} = 90
...
@with_kw type ScaleLimit <: AbstractEChartType
    min::Union{Int64,Void} = nothing
    max::Union{Int64,Void} = nothing
end
...
@with_kw type Parallel <: AbstractEChartType
    ...
    left::Union{Int64,String,Void} = "auto"
    top::Union{Int64,String,Void} = 60
    right::Union{Int64,String,Void} = 80
    bottom::Union{Int64,String,Void} = 60
    width::Union{Int64,String,Void} = "auto"
    height::Union{Int64,String,Void} = "auto"
...
@with_kw type ParallelAxis <: AbstractEChartType
    dim::Union{Int64,Void} = nothing
    parallelIndex::Union{Int64,Void} = 0
...
@with_kw type Series <: AbstractEChartType
    ...
    stack::Union{Int64,String,Void} = nothing
    left::Union{String,Void} = nothing
    right::Union{String,Void} = nothing
    top::Union{Int64,Void} = nothing
    bottom::Union{Int64,Void} = nothing
...
@with_kw type EChart <: AbstractEChartType
    ...
    animationDuration::Union{Int64,Void} = nothing
    animationEasing::Union{String,Void} = nothing
    animationDelay::Union{Int64,Void} = nothing
    animationDurationUpdate::Union{Int64,Void} = nothing
    animationEasingUpdate::Union{String,Void} = nothing
    animationDelayUpdate::Union{Int64,Void} = nothing
end
